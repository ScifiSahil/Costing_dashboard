  ...
  return (
    <div className="bg-gray-50 flex flex-col h-screen">
      ...
      <div className="bg-white border-b border-gray-300 shadow-sm">
        ...
        <div className="px-3 py-2 bg-gradient-to-r from-slate-50 via-white to-slate-50 border-t border-gray-200 shadow-sm">
          <div className="flex flex-col gap-2">
            {/* Category Selection Buttons */}
            <div className="flex items-center gap-2">
              <button
                onClick={() => setSelectedCategory("All")}
                className={`px-3 py-1.5 rounded-md font-medium text-xs transition-all duration-300 transform hover:scale-105 ${
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    {Object.keys(plants).length - 1}
                  </span>
                </div>
              </button>

              <button
                onClick={() => setSelectedCategory("Forging")}
                className={`px-3 py-1.5 rounded-md font-medium text-xs transition-all duration-300 transform hover:scale-105 ${
            ...
            <div className="flex flex-wrap items-center gap-1.5">
                        ...
                        >
                          ...
                          <div
                            className={`w-1.5 h-1.5 rounded-full ${
                              ...
                              plant.status === "active" ? "animate-pulse" : ""
                            }`}
                          ></div>
              ...
              {selectedCategory === "Machining" && (
                <>
                  {machiningPlants.map(([name, plant]) => (
                    <button
                      key={name}
                      onClick={() => setSelectedPlant(name)}
                      className={`flex items-center gap-1 px-2 py-1 rounded-md transition-all duration-200 whitespace-nowrap text-xs font-medium ${
