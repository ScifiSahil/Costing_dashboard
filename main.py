...
def _setup(self, request):
    ...
    return "kalyani-iot-costing-MainComponent"
...
def _register_libraries():
    lib = static.Library("kalyani-iot-costing", "0.0.1",
                         os.path.join(os.path.dirname(__file__), 'js', 'build'))
    lib.add_file("kalyani-iot-costing.js")
    lib.add_file("kalyani-iot-costing.js.map")
